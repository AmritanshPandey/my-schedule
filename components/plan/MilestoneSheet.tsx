...
export interface MilestoneSaveData {
  id?: string;   // pre-generated by caller when the ID is needed before creation
  title: string;
  description?: string;
  notes?: string;
  startDate: string;
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <div className="relative">
                ...
                <IconChevronDown size={14} strokeWidth={2} className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-neutral-500 dark:text-neutral-400" />
              </div>
            </div>
          </div>
